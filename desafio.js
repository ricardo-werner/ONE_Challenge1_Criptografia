...
// para conseguir realizar esta ação, é necessário que o usuário permita acesso a área de transferência no browser
...
btnColar.addEventListener("click", async (e) => {
    ...
    alert("Inserir o texto copiado no campo de criptografia, clique em Ok !!!");
